...
#define configurationFlag1_M1     (VBUS_SENSING_FLAG|TEMP_SENSING_FLAG|OTF_STARTUP_FLAG)
#define configurationFlag2_M1     (DBG_MCU_LOAD_MEASURE_FLAG|DBG_OPEN_LOOP_FLAG|QUASI_SYNC_FLAG)
