...
/* */
void TSK_SetBrakeDelayM1(uint16_t hTickCount);

/* */
bool TSK_BrakeDelayHasElapsedM1(void);

/* */
void TSK_SetOTFDetectionDelayM1(uint16_t hTickCount);

/* */
bool TSK_OTFDetectionDelayHasElapsedM1(void);
...
void TSK_SpeedTIM_task(void);
 ...
 /* Execute the bemf zero crossing detection task*/
void TSK_BEMF_ZCD_Task(void);
